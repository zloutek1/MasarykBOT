...
class MockGuild(CustomMockMixin, unittest.mock.MagicMock, HashableMixin):
...
class MockBot(CustomMockMixin, unittest.mock.MagicMock):
    ...
    """
    spec_set = bot.MasarykBOT(command_prefix=unittest.mock.MagicMock(), loop=_get_mock_loop())
...
class MockConnection(unittest.mock.AsyncMock):
