...
from __oild.bot.cogs import setup_injections as setup_cog_injections
from src.bot import connect_db, Pool, setup_injections as setup_db_injections
from src.bot import setup_logging, DatabaseRequiredException
