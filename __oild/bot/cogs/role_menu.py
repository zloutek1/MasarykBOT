...
from src.bot import GuildMessage
...
class RoleMenuService:
    def __init__(
        self,
        bot: commands.Bot,
        parsing_service: Optional[ActionParsingService] = None,
        channel_action_service: Optional[ChannelActionService] = None
    ) -> None:
        self.bot = bot
    ...
    async def load_role_menu_messages(self) -> Dict[int, GuildMessage]:
        ...
        for guild_config in CONFIG.guilds:
            ...
            assert channel_id, "about you channel id not found in config"
    ...
    async def update_role_menu(self, message: discord.Message) -> None:
...
class RoleMenuCog(commands.Cog):
    def __init__(self, bot: commands.Bot, service: Optional[RoleMenuService] = None) -> None:
        self.bot = bot
